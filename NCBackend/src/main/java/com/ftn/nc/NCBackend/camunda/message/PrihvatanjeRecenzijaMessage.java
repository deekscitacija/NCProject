...
@Service
public class PrihvatanjeRecenzijaMessage implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		porukaAutor += "<html>"+
				  "<body>"+
				  "<div>\r\n" + 
				  "<h3>Objava rada prihvacena</h3>"+
				  "<p>Postovani "+autor.getIme()+" "+autor.getPrezime()+", Vas zahtev za objavu rada u casopis \""+casopis.getNaziv()+"\" je prihvacen. </p>"+
				  "<p>Nakon izvrsene recenzije, Vas rad je <b>prihvacen</b> za objavu od strane recenzenata.</p>"+
				  "</div>"+
				  "</body>"+
				  "</html>";
